...
This is an implementation for the predictive Lassa fever models used in the Sentinel Forecasting (Trinity Challenge) project.

## Installation

You can install the development version of lassamodels from [GitHub](https://github.com/) with:
